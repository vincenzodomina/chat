...
<TypeTable
  type={{
    ...
    fallbackStreamingPlaceholderText: {
      description: 'Placeholder text used when fallback streaming (post + edit) starts. Set to null to avoid creating an initial placeholder message.',
      type: 'string | null',
      default: '"..."',
    },
    fallbackStreamingMinInitialChars: {
      description: 'Minimum characters required before creating the first message when fallbackStreamingPlaceholderText is null.',
      type: 'number',
      default: '0',
    },
  }}
